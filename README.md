...
-	Copolymer approach – only for PVPVAc and PLGA copolymers due to individual modeling treatment reqiured for each copolymer. Any now copolymer must be explicitly implemented to the code
...
-	Since it is fully controlled by Input_ASD.inp, you can ignore downloading and compiling source codes (.f90). Instead, you can directly run PC_SAFT_ASD.exe (Windows) or PC_SAFT_ASD.prog (Linux) 
